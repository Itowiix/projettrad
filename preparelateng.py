...
with open("C:/Users/Corniere/Desktop/stage/TradNLPlateng/latin_en_cgrosenthal.csv", encoding="utf-8") as f:
    for line in f:
        if ";" in line:
...
with open("C:/Users/Corniere/Desktop/stage/TradNLPlateng/bpe_corpus.txt", "w", encoding="utf-8") as f:
    for s in latin_sents + en_sents:
        f.write(s + "\n")

# === 3. Entraîner SentencePiece BPE ===
spm.SentencePieceTrainer.Train(
    input='C:/Users/Corniere/Desktop/stage/TradNLPlateng/bpe_corpus.txt',
    model_prefix='C:/Users/Corniere/Desktop/stage/TradNLPlateng/bpe_model',
    vocab_size=8000,
    model_type='bpe',
...
os.makedirs("C:/Users/Corniere/Desktop/stage/TradNLPlateng/processed2/tf_dataset_bpe", exist_ok=True)
tf.data.experimental.save(dataset, "C:/Users/Corniere/Desktop/stage/TradNLPlateng/processed2/tf_dataset_bpe")
